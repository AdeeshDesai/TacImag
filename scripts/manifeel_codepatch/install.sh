#!/bin/bash
# TacImag copy of ManiFeel's install.sh.
# Single change: the conda environment name is configurable via CONDA_ENV_NAME
# (default "tacimag") instead of being hardcoded to "manifeel".
...
# <miniforge_home>/envs/$CONDA_ENV_NAME. Press Enter to accept the detected default.
...
get_conda_env_path() {
    ...
    CONDA_ENV_PATH="$MINIFORGE_HOME/envs/$CONDA_ENV_NAME"
